...
public class FollowerConstants {
    ...
    private static double xMovement = 75.81798987524398;
    private static double yMovement = 36.719677375078426;
    ...
    public static double centripetalScaling = 0.00023;


    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double forwardZeroPowerAcceleration = -42.9316560299861;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -94.93057789876006;
