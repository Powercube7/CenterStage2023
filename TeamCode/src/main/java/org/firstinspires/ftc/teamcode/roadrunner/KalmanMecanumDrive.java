...
@Config
public class KalmanMecanumDrive extends MecanumDrive {
    ...
    public static KalmanFilter filter = new KalmanFilter();
    ...
    public KalmanMecanumDrive(HardwareMap hardwareMap) {
        ...
        distanceSensor = hardwareMap.get(Rev2mDistanceSensor.class, "distance_wall");
